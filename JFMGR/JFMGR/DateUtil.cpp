...
char* createFormattedTime(unsigned int unixTime, const char* format, const char* lang) {
	/*输出格式化时间一律为北京时间*/
	if (unixTime == 0) {
...
char* getFormattedTime(unsigned int unixTime) {
	return createFormattedTime(unixTime, "yyyy.mm.dd", "en-US");
}

char* getFormattedTime(unsigned int unixTime, const char* format) {
	return createFormattedTime(unixTime, format, "en-US");
}

char* getFormattedTime(unsigned int unixTime, const char* format, const char* lang) {
	return createFormattedTime(unixTime, format, lang);
}
